  ...
  <div v-else>
    ...
    >
      <ul
        ...
        <li class="td list-group-item text-start px-2 border rounded" style="width: 100%;"> 
          {{ item.nNf }} 
        </li>
        ...
        <li 
          class="td list-group-item text-start px-2 border rounded"
          style="width: 100%; color: #00AD8C;">
          {{
        ...
        <li
          class="td list-group-item text-start px-2 border rounded"
          style="width: 100%; color: #00AD8C; text-transform: uppercase;">
